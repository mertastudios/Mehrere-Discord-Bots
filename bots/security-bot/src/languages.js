...
const STRINGS = {
  de: {
    ...
    helpCheckNow: 'Wertet die bisher gesammelten Nachrichten sofort aus, ohne auf das Token-Limit oder Mitternacht zu warten.',
...
- Kein Verstoß: niemanden moderieren, höchstens kurz und locker im Chat antworten`,
  ...
  en: {
    ...
    helpCheckNow: 'Analyzes the currently collected messages right away, without waiting for the token limit or midnight.',
...
- No violation: don't moderate anyone, at most reply briefly and casually in chat`,
  ...
  fr: {
    ...
    helpCheckNow: 'Analyse immédiatement les messages déjà collectés, sans attendre la limite de tokens ou minuit.',
...
- Aucune infraction : ne modérer personne, au maximum répondre brièvement dans le chat`,
  ...
  es: {
    ...
    helpCheckNow: 'Analiza de inmediato los mensajes ya recopilados, sin esperar el límite de tokens ni la medianoche.',
...
- Sin infracción: no moderar a nadie, como mucho responder brevemente en el chat`,
  ...
  pt: {
    ...
    helpCheckNow: 'Analisa imediatamente as mensagens já coletadas, sem esperar o limite de tokens ou a meia-noite.',
...
- Sem infração: não moderar ninguém, no máximo responder de boa no chat`,
  ...
  ru: {
    ...
    helpCheckNow: 'Немедленно анализирует уже собранные сообщения, не дожидаясь лимита токенов или полуночи.',
...
- Нет нарушений: никого не наказывать, максимум коротко ответить в чате`,
  ...
  ja: {
    ...
    helpHelp: 'この概要を表示します。',
    helpCheckNow: 'トークン上限や午前0時を待たずに、これまでに収集したメッセージを今すぐ分析します。',
...
- 違反なし：誰も罰せず、せいぜいチャットで軽く短く返信`,
  ...
  ko: {
    ...
    helpCheckNow: '토큰 한도나 자정을 기다리지 않고 지금까지 수집된 메시지를 즉시 분석합니다.',
    logModTitle: '🛡️ AI 검열',
    logFieldUser: '사용자',
    logFieldAction: '조치',
...
- 위반 없음: 누구도 처벌하지 말고 최대한 가볍게 채팅으로 답하기`,
  ...
  zh: {
    ...
    helpHelp: '显示此概览。',
    helpCheckNow: '无需等待令牌上限或午夜，立即分析目前已收集的消息。',
    logModTitle: '🛡️ AI 审核',
    logFieldUser: '用户',
    logFieldAction: '措施',
...
- 没有违规：不处罚任何人，最多在聊天中轻松地简短回复`,
  ...
  it: {
    ...
    helpCheckNow: 'Analizza subito i messaggi già raccolti, senza attendere il limite di token o la mezzanotte.',
